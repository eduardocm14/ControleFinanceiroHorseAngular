...
type
  ...
  public
    ...
    class function GetByDataVencimento(DataInicial, DataFinal: TDateTime): TJSONArray;
...
class function TContaDAO.GetByDataVencimento(DataInicial, DataFinal: TDateTime): TJSONArray;
var
  Conexao: TConexaoODBC;
  Qry: TADOQuery;
  Lista: TJSONArray;
...
begin
  ...
  try
    ...
    Qry.Parameters.ParamByName('DataInicial').Value := DataInicial;
    Qry.Parameters.ParamByName('DataFinal').Value := DataFinal;
...
begin
  ...
  try
    ...
    Qry.SQL.Text :=
      'UPDATE "Contas" SET ' +
      '"Nome" = :Nome, "Valor" = :Valor, "DataVencimento" = :DataVencimento ' +
      'WHERE "Id" = :Id';
